...
function AddNewItem({ config }) {
  ...
  //   navigate(`/${entity.toLowerCase()}/bulk`);
  // };
...
//     navigate(`/${entity.toLowerCase()}/${value}`);
//   };

//   return (
//     <Select placeholder={translate('Add New Invoice')}
//       style={{ width: '156px' }}
//       onSelect={handleSelect}
//     >
//       <Select.Option key="single" value="create">
//         Single
//       </Select.Option>
//       <Select.Option key="bulk" value="bulk">
//         Bulk
//       </Select.Option>
//     </Select>
//   );
